...
const MyImage = require('./build/contracts/Inbox.json');
...
const sendImage =  await myImage.methods.sendIPFS(id,fileHash).send({from: address});
console.log(sendImage);
res.send(" Gửi lên IPFS thành công ID  của ảnh : " + ` ${ id } `);
